...
class LetterSounds extends StatefulWidget {
  ...
  LetterSounds({required this.optionTitle});

  @override
  State<LetterSounds> createState() => _LetterSounds();
}
...
class _LetterSounds extends State<LetterSounds> with SingleTickerProviderStateMixin {
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () async {
                ...
                SoundManager.playSound(alphabet.toLowerCase());
